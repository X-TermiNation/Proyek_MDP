...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(RoomDatabase __db) {
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `user` SET `id` = ?,`name` = ?,`email` = ?,`password` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public void insertComment(final Comment newComment) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfComment.insert(newComment);
      __db.setTransactionSuccessful();
    } finally {
      __db.endTransaction();
    }
  ...
  @Override
  public List<User> loginUser(final String email, final String password) {
    final String _sql = "select * from user where LOWER(email) = LOWER(?) and password =?";
